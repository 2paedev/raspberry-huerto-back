...
SECRET_KEY = '3bya+dqcxusi_&+hikcs5-1@z5555te)z$_ryf8xpz@^j$*8zg'
VERSION = 'v01'
...
ROOT_URLCONF = 'raspberry_huerto_back.urls'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'raspberry_huerto_back.utils.custom_exception_handler',
}
